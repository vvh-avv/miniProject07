		...
		<table width="600" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><select name="paymentOption"
					...
					maxLength="20">
						<option value="1"
							${ purchase.paymentOption == "1" ? "selected" : ""  }
							selected="selected">현금구매</option>
						<option value="1"
							${ purchase.paymentOption == "2" ? "selected" : ""  }
							selected="selected">신용구매</option>
				</select></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			...
			<tr>
				...
				<td width="200" class="ct_write01"><input type="text"
					...
					style="width: 100px; height: 19px" maxLength="20"
					value="${purchase.divyDate==null?'':purchase.divyDate}" /> <img
